...
//lines 12-18 declares and sets variables with respective DOM input. lines 19-25 declare variables needed for calculations
	...
	var floatCircleCircum = 2 * Math.PI * floatRadius; 
...
//    $("rect_width").value = floatRectWidth;
//    $("rect_height").value = floatRectHeight;
//    $("tri_side1").value = floatTriSide1;
//    $("tri_side2").value = floatTriSide2;
//    $("tri_side3").value = floatTriSide3;
//    $("radius").value = floatCircleCircum;
