...
floatTotalPts = parseFloat(floatHwPts + floatMidPts + floatFinPts); // Adds up homework points, midterm, and final points 

intGradeOption = parseInt(prompt("Please choose grade option 1 || 2:")); // The user can choose whether they want to receive a letter grade or audit the course
